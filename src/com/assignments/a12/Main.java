...
public class Main {
    public static void main(String[] args) {
        ...
        printAllDepartmentNames(studentList);
        printNamesOfStudentsEnrolledAfter2018(studentList);
    ...
    private static void printAllDepartmentNames(List<Student> studentList) {
        System.out.println("Print all department names in the college:");
        studentList.stream()
    ...
    private static void printNamesOfStudentsEnrolledAfter2018(List<Student> studentList) {
    ...
    private static void printMaleStudentsInCS(List<Student> studentList) {
        System.out.println("Male students details in the Computer Science department:");
    ...
    private static void countMaleAndFemaleStudents(List<Student> studentList) {
        ...
        System.out.println("No of male students: " + genderCount.get("Male"));
        System.out.println("No of female students: " + genderCount.get("Female"));
        System.out.println();
    }
    ...
    private static void calculateAverageAgeByGender(List<Student> studentList) {
        ...
        System.out.println("Avg age of male students: " + averageAgeByGender.get("Male"));
        System.out.println("Avg age of female students: " + averageAgeByGender.get("Female"));
        System.out.println();
    }
    ...
    private static void calculateAveragePercentageByDepartment(List<Student> studentList) {
        ...
        System.out.println("Avg percentage achieved in each department:");
    ...
    private static void countMaleAndFemaleStudentsInCS(List<Student> studentList) {
        Map<String, Long> genderCountInCS = studentList.stream()
                ...
                .collect(Collectors.groupingBy(Student::getGender, Collectors.counting()));
        System.out.println("No of male students in CS: " + genderCountInCS.get("Male"));
        System.out.println("No of female students in CS: " + genderCountInCS.get("Female"));
    }
